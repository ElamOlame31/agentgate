...
# Default path matches core.audit.DB_PATH.  We do not import core.audit here
# so this module stays stdlib-only and testable without pydantic/fastapi.
_DEFAULT_DB_PATH = Path(__file__).parent.parent / "agentgate_audit.db"
