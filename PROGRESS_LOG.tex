...
% ─────────────────────────────────────────────────────────────────────────────
\section{90-Day Roadmap — What Comes After the Sprint}

This section documents where AgentGate goes after the 14-day prototype.
The goal of the sprint is to prove the concept. The goal of the next 90 days
is to build something a company would actually pay for.

\subsection{Phase 1 — Making the Demo Real (Days 15--30)}
...
\subsection{Phase 2 — Enterprise Features (Days 30--60)}
...
\subsection{Phase 3 — The Product (Days 60--90)}
